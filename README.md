...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0D1117,100:00FF9C&height=180&section=header&text=KRISHNANSH%20VASANIYA&fontSize=38&fontColor=FFFFFF&animation=fadeIn&fontAlignY=38&desc=Associate%20Software%20Engineer%20%C2%B7%20Salesforce%20Developer%20%C2%B7%20AI%20Engineer&descAlignY=58&descSize=16&descColor=00FF9C" width="100%"/>

<a href="https://git.io/typing-svg">
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=20&duration=3000&pause=1000&color=00FF9C&center=true&vCenter=true&width=600&lines=Building+enterprise+Salesforce+systems;Exploring+AI+%2F+Computer+Vision;Automating+the+repetitive+stuff;Shipping+something+new" alt="typing animation" />
</a>
...
I build enterprise applications on Salesforce — Apex, LWC, OmniStudio, Flows — at TechMatrix Consulting, currently working on a Loan Origination System. Outside that, I experiment with AI, computer vision, edge computing, and automation.
...
<img src="https://skillicons.dev/icons?i=py,js,html,css,react,nodejs,git,github,vscode,aws,mongodb,mysql,tensorflow&theme=dark" />
...
**High-Speed Pothole Detection** — LiDAR + sensor fusion for real-time pothole detection on the road.
`90%+ accuracy` · `15K+ readings/sec` · `70% faster inspection`
[→ Repo](https://github.com/KrishnanshVasaniya/pothole-detection-ai)

**Salesforce Metadata Explorer** — Chrome extension that searches Salesforce metadata from local XML for instant developer navigation.
`Objects` · `Fields` · `Flows` · `Apex` · `LWC`

**AI Face Recognition Attendance** — Streamlit app for real-time attendance via facial recognition.
`95% accuracy`
...
Ongoing experiments, not shipped products: AI video stylization (PyTorch, FFmpeg), local inference on Apple Silicon, a Shorts automation pipeline, and day-to-day AI-assisted developer workflows with Claude and Cursor.
